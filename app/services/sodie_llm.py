...
SODIE_BASE_RULES = (
    ...
    "5. Recipe edits become reviewable proposals the user must approve; never claim "
    "you silently changed a recipe. To swap a planned meal, tell them to use the "
    "Swap button on that recipe card—do not claim you can modify the plan in chat.\n"
